...
export class TransferComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.status = this.listsService.getListByName('transfer', 'status');
    ...
    if(this.f.id.value == null) {
      ...
      this.bankTransactionsService.create(this.formDeposit.value)
        .subscribe(data => { 
          ...
          this.toastr.success('Transfer has been created!')
        },
      ...
      this.bankTransactionsService.update(this.formDeposit.value)
        .subscribe(data => { 
          ...
          this.toastr.success('Transfer has been saved!')
        },
        (err: HttpErrorResponse) => {
          if(err.error.error)
            this.toastr.error(err.error.error);
